...
export default function Headingagebanner({
  ...
  return (
    <div className="relative lg:min-h-[50vh] py-4 flex items-center justify-center bg-black overflow-hidden">
      ...
      <div className="relative z-10 text-center">
        <h1 className="text-primary moving-gradient text-3xl md:text-8xl font-bold">
          {pagename}
        </h1>
      </div>
    </div>
