...
// 👇 Ab saare images array me hain, JSX me repeat nahi karna padega
const slideColumns = [
  {
    scrollClass: "v-scroll",
    images: [
      "/img/graphimg/tradeimg2.jpg",
      "/img/graphimg/tradeimg3.jpg",
      "/img/graphimg/tradeimg4.jpg",
      "/img/graphimg/tradeimg5.jpg",
      "/img/graphimg/tradeimg6.jpg",
      "/img/graphimg/tradeimg19.jpg",
    ],
  },
  {
    scrollClass: "scroll2",
    images: [
      "/img/graphimg/tradeimg11.jpg",
      "/img/graphimg/tradeimg12.jpg",
      "/img/graphimg/tradeimg13.jpg",
      "/img/graphimg/tradeimg33.jpg",
      "/img/graphimg/tradeimg15.jpg",
      "/img/graphimg/tradeimg16.png",
    ],
  },
  {
    scrollClass: "scroll3",
    images: [
      "/img/graphimg/tradeimg22.jpg",
      "/img/graphimg/tradeimg23.png",
      "/img/graphimg/tradeimg24.png",
      "/img/graphimg/tradeimg25.jpg",
      "/img/graphimg/tradeimg26.jpg",
      "/img/graphimg/tradeimg7.png",
    ],
  },
];
...
export default function BannerSection() {
  return (
    <div className="min-h-screen md:h-[100vh] overflow-hidden flex justify-center relative px-4 sm:px-6 md:px-0 py-10 md:py-0">
      {/* Decorative animated line - chhota screen pe hide/scale down */}
      <div className="absolute top-4 left-4 md:top-10 md:left-10 opacity-20 hidden sm:block">
        <svg
          className="absolute left-0 top-[40%] opacity-96 w-[260px] h-[160px] md:w-[500px] md:h-[300px]"
          viewBox="0 0 500 300"
        >
          <path
            d="M20 220 L100 180 L180 190 L260 100 L340 120 L420 50"
      ...
      */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-6 relative w-full max-w-7xl items-center">
        ...
        <div className="col-span-1 flex flex-col justify-center text-center md:text-left order-1">
          ...
          <p className="text-gray-600 mt-4 leading-snug md:leading-tight text-sm sm:text-base">
            A complete trading ecosystem for Indian traders — covering equities,
            options, forex strategies, prop firm systems, and automation.
          </p>

          <ul className="mt-8 md:mt-10 flex flex-col sm:flex-row gap-4 items-center justify-center md:justify-start">
            <li className="w-full sm:w-auto">
              <a
                href="#"
                className="startbtn w-full inline-flex justify-center items-center gap-2"
              >
                Start Your Journey <AiFillThunderbolt />
              </a>
            </li>
            <li className="w-full sm:w-auto">
              <a
                href="#"
                className="getstartedbtn w-full inline-flex justify-center items-center"
              >
                Live Class
              </a>
            </li>
          ...
          <div className="hero-bg_wrap-cols h-full">
            {slideColumns.map((col, colIndex) => (
              <div className="hero-bg_wrap-col" key={colIndex}>
                ...
                {[0, 1].map((groupIndex) => (
                  <div
                    className={`hero-bg_wrap-slides ${col.scrollClass}`}
                    key={groupIndex}
                  >
                    {col.images.map((src, imgIndex) => (
                      <div
                        className="hero-bg_wrap_slide"
                        key={`${colIndex}-${groupIndex}-${imgIndex}`}
                      >
                        <img
                          src={src}
                          alt={`Hero Slide ${colIndex}-${groupIndex}-${imgIndex}`}
