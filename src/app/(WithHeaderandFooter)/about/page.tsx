...
export default function About() {
  ...
  return (
    <>
      ...
      <div className="relative lg:py-24 py-8 bg-[#f8fafc] overflow-hidden">
        ...
        <div className="section-container relative z-10">
          <div className="text-center">
            <h2 className="lg:text-4xl text-2xl font-bold mb-1">
              Built for Traders Who Think Long Term
            </h2>
            <p className="text-gray-500 mt-3 lg:text-[16px] text-[13px] max-w-3xl mx-auto">
        ...
        <div className="section-container mt-20">
          <div className="relative">
            ...
            <div className="grid lg:grid-cols-3 gap-8">
              <div className="relative bg-white rounded-[30px] lg:p-8 p-4 py-6 shadow-xl border border-[#E8F5E1] hover:-translate-y-3 hover:shadow-2xl transition-all duration-300">
                <div className="absolute top-6 right-6 text-6xl font-black text-[#7ED957]/10">
                  01
                </div>

                <div className="lg:w-20 lg:h-20 w-10 h-10 text-[12px] lg:text-2xl rounded-full bg-[#7ED957] text-white flex items-center justify-center  font-bold lg:mb-8 mb-4 shadow-lg">
                  01
                </div>
                ...
                <p className="text-gray-600 leading-6 lg:text-[16px] text-[14px] ">
      ...
      <section className="relative lg:py-24 py-8 bg-black overflow-hidden">
        {/* Glow Effects */}
        ...
        <div className="section-container relative z-10">
          {/* Heading */}
          <div className=" text-center">
            <h2 className="lg:text-4xl text-2xl font-bold text-white mb-1">
              Our Mission & Vision
            </h2>

            <p className="text-gray-400 lg:text-lg text-sm leading-6">
          ...
          {/* Cards */}
          <div className="grid lg:grid-cols-2 gap-8 lg:mt-16 mt-6"> 
            {/* Mission */}
            <div className="group relative rounded-[32px] border border-white/10 bg-white/[0.03] backdrop-blur-sm lg:p-10 p-4 hover:border-[#7ED957]/50 transition-all duration-500">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-white lg:text-2xl text-xl font-bold mt-5 mb-6">
                  Bring Structure and Discipline to Trading
                </h3>

                <p className="text-gray-400 leading-2 lg:text-lg text-sm">
                  Our mission is to help traders move away from randomness,
                  emotional decision-making, and shortcut-driven behavior. We
                  focus on teaching structured thinking, risk awareness, and
                  rule-based execution across markets.
                </p>

                <p className="text-gray-400 leading-2 lg:text-lg text-sm mt-2">
                  Every product, system, and educational program at Stokzy is
                  built to reinforce consistency, accountability, and long-term
                  survival in the markets.
                </p>
              </div>
            </div>
            ...
            <div className="group relative rounded-[32px] border border-white/10 bg-white/[0.03] backdrop-blur-sm lg:p-10 p-4 hover:border-[#7ED957]/50 transition-all duration-500">
              ...
              <div className="relative z-10">
                ...
                <p className="text-gray-400 leading-2 lg:text-lg text-sm">
                  Our vision is to create a comprehensive ecosystem where
                  traders can learn, build, test, and execute systems with
                  clarity and confidence regardless of market conditions.
                </p>

                <p className="text-gray-400 leading-2 lg:text-lg text-sm mt-2">
                  We aim to raise the standard of retail trading by promoting
                  professional frameworks, responsible risk-taking, and a
                  mindset focused on longevity rather than short-term outcomes.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="relative lg:py-24 py-8 bg-[#f8fafc] overflow-hidden">
        {/* Background Glow */}
        ...
        <div className="section-container relative z-10">
          {/* Heading */}
          <div className="text-center">
            <h2 className="lg:text-4xl text-2xl font-bold  mb-1">Founders & Directors</h2>

            <p className="text-gray-600 text-lg leading-6 lg:text-[16px] text-[14px]">
              Stokzy is led by its founders with a long-term focus on
              discipline, structure, and responsible participation in financial
              markets.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 mt-16">
            {/* Founder */}
            <div className="bg-white rounded-[32px] lg:p-10 p-4 shadow-xl border border-gray-100 hover:-translate-y-2 hover:shadow-2xl transition-all duration-300">
              <div className="flex justify-center">
                <img
                  src="/img/ashishweb.webp"
                  alt="Founder"
                  className="lg:w-52 lg:h-52  w-36 h-36 rounded-full object-cover border-4 border-[#7ED957]/20"
                />
              </div>
              ...
              <p className="text-gray-600 leading-6 lg:text-[16px] text-[14px] mt-4">
      ...
      <section className="relative py-12 bg-[#f8fafc] overflow-hidden">
        ...
        <div className="section-container relative z-10">
          <div className="text-center lg:mb-16 mb-4">
            <h2 className="text-3xl font-bold mb-1 mt-5">Our Tutors</h2>

            <p className="text-gray-600 text-lg leading-6 lg:text-[16px]">
              Learn from experienced traders and educators focused on structured
              thinking, risk awareness, and disciplined execution.
            </p>
          </div>
            ...
            {tutors.map((item, index) => (
              <SwiperSlide key={index} className="mb-10">
                <div className="bg-white rounded-[30px] p-8 border border-gray-100 shadow-lg hover:-translate-y-2 hover:shadow-2xl transition-all duration-300 h-full">
                  <div className="flex justify-center">
                    <div className="relative lg:w-52 lg:h-52  w-36 h-36 mb-6 overflow-hidden rounded-full bg-zinc-800">
                      <Image
                        src={item.image}
                        alt={item.name}
                        fill
                  ...
                  <div className="text-center mt-2">
                    ...
                    <p className="text-[#7ED957] lg:text-sm text-[12px] font-medium">
                      {item.role}
                    </p>
                  </div>

                  <p className="text-gray-600 text-center leading-6 lg:mt-4 mt-2">
                    {item.desc}
                  </p>
                </div>
              </SwiperSlide>
      ...
      <section className="relative py-12 bg-[#f8fafc] overflow-hidden">
        ...
        <div className="section-container relative z-10">
          ...
          <div className="text-center mb-6">
            <h2 className="text-3xl font-bold mb-1">What We Stand For</h2>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="bg-gradient-to-br from-[#111111] to-[#181818] border border-white/10 rounded-[32px] p-10 md:p-16 text-center">
              ...
              <p className="text-gray-500 leading-8 max-w-3xl mx-auto">
                ...
                Past performance should never be considered a guarantee of
                future results.
              </p>
            </div>
          </div>
  ...
  {/* Glow Effect */}
  <div className="absolute left-0 top-0 w-52 h-52 md:w-96 md:h-96 bg-[#7ED957]/10 blur-[100px] md:blur-[180px]" />
  <div className="absolute right-0 bottom-0 w-52 h-52 md:w-96 md:h-96 bg-[#7ED957]/10 blur-[100px] md:blur-[180px]" />

  <div className="section-container relative z-10">
    <div className="max-w-5xl mx-auto px-4 md:px-0">
      <div className="bg-gradient-to-br from-[#111111] to-[#181818] border border-white/10 rounded-2xl md:rounded-[32px] p-2 sm:p-10 md:p-16 text-center">
        {/* 
  <span className="inline-flex items-center px-4 py-2 rounded-full bg-[#7ED957]/10 text-[#7ED957] text-sm font-medium mb-6">
    RESPONSIBILITY FIRST
  </span> */}

        <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold text-white mb-5 md:mb-8">
          Responsibility & Transparency
        </h2>

        <p className="text-gray-400 text-sm sm:text-base md:text-lg leading-7 md:leading-9 max-w-4xl mx-auto">
          Stokzy provides education, tools, and trading frameworks only. We do
          not provide investment advice, guarantees, portfolio management, or
          brokerage services.
        </p>

        <div className="w-16 md:w-24 h-[2px] bg-[#7ED957] mx-auto my-6 md:my-8"></div>

        <p className="text-gray-500 text-sm md:text-base leading-6 md:leading-8 max-w-3xl mx-auto">
          Trading involves substantial risk. Outcomes depend on individual
          decisions, market conditions, risk management, and execution. Past
          performance should never be considered a guarantee of future
          results.
        </p>
      </div>
    </div>
