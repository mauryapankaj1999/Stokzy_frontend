...
export default function Community() {
  const [gainsection, setGainsection] = useState([
    ...
    },
    {
      ...
      description: "Encourages rule-following and disciplined participation.",
      icon: "shield",
    },
    {
      title: "Prop Firm Preparation",
      description: "Evaluation-focused system refinement and risk frameworks.",
      icon: "bank",
    },
  ]);
  ...
  return (
    <>
      <div className="relative lg:py-24 py-12 bg-[#f8fafc] overflow-hidden">
        ...
        <div className="section-container">
          <div className="text-center">
            <h3 className="text-primary moving-gradient lg:text-5xl text-2xl font-bold">
              Where Serious Traders Build <br /> Discipline Together
            </h3>
            <p className="text-[#515151] lg:text-[18px] text-[14px] lg:my-8 my-4 ">
      ...
      <div className="lg:py-20 py-10 bg-[#F8FAFC]">
        <div className="section-container">
          <div className="text-center">
            <h3 className="lg:text-4xl text-2xl font-bold  mb-5">
              Inside the Community
            </h3>
          </div>
          <div className="grid grid-cols-3 lg:gap-8 gap-4 mt-10">
              ...
              <div className="relative min-h-[310px] overflow-hidden group bg-[#F7F9FB] border border-gray-200 rounded-2xl p-8 shadow-sm hover:shadow-2xl hover:border-[#7ED957]/50 transition-all duration-500 hover:-translate-y-3">
                <div className="relative z-10">
                  ...
                  <p className="text-[#515151] text-lg leading-8 mt-8">
                    Structured breakdowns of setups, risk logic, and execution
                    decisions.
                  </p>
                </div>
            ...
            <div className="col-span-1">
              <div className="relative min-h-[310px] overflow-hidden group bg-[#F7F9FB] border border-gray-200 rounded-2xl p-8 shadow-sm hover:shadow-2xl hover:border-[#7ED957]/50 transition-all duration-500 hover:-translate-y-3">
                <div className="relative z-10">
                  ...
                  <p className="text-[#515151] text-lg leading-8 mt-8">
                    Weekly reviews of indices, options flow, and forex
                    structure.
                  </p>
                </div>
      ...
      <div className="lg:py-24 py-12">
        <div className="section-container">
          ...
          {/*
      Mobile: flex + overflow-x-auto + snap -> cards horizontally scroll
      Desktop (lg+): grid grid-cols-4 -> bilkul original jaisa
      "no-scrollbar" class niche di gayi CSS se scrollbar visually hide karti hai
    */}
          <div className="flex gap-4 overflow-x-auto snap-x snap-mandatory pb-4 -mx-4 px-4 no-scrollbar lg:mx-0 lg:px-0 lg:pb-0 lg:grid lg:grid-cols-4 lg:overflow-visible">
            {/* Card 1 */}
            <div className="shrink-0 w-[78%] sm:w-72 snap-start lg:w-auto lg:shrink lg:col-span-1">
              <div className="relative lg:min-h-[310px] overflow-hidden group bg-[#F7F9FB] border border-gray-200 rounded-2xl lg:p-8 p-4 shadow-sm hover:shadow-2xl hover:border-[#7ED957]/50 transition-all duration-500 hover:-translate-y-3">
                <div className="relative z-10">
                  <div className="w-14 h-14 flex items-center justify-center rounded-md mb-9 bg-[#EAF0F9]">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  <h5 className="lg:text-[20px] text-[16px] lg:my-4 my-2 font-semibold">
                    Live Trade Discussions
                  </h5>
                  <p className="text-[#515151] lg:text-lg text-[14px] lg:mt-8 mt-2">
                    Structured breakdowns of setups, risk logic, and execution
                    decisions.
                  </p>
                </div>
            ...
            {/* Card 2 */}
            <div className="shrink-0 w-[78%] sm:w-72 snap-start lg:w-auto lg:shrink lg:col-span-1">
              <div className="relative lg:min-h-[310px] overflow-hidden group bg-[#F7F9FB] border border-gray-200 rounded-2xl p-8 shadow-sm hover:shadow-2xl hover:border-[#7ED957]/50 transition-all duration-500 hover:-translate-y-3">
                <div className="relative z-10">
                  <div className="w-14 h-14 flex items-center justify-center rounded-md mb-9 bg-[#EAF0F9]">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
      ...
      <section className="lg:py-20 pt-12 bg-[#F8FAFC]">
        <div className="section-container">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            {/* Right Content */}
            <div>
              <h2 className="lg:text-4xl text-2xl font-bold  mb-5">
                Structured Conversations.
                <br />
                Real Market Context.
              </h2>

              <p className="text-[#515151] lg:text-lg text-[15px] lg:mt-4">
              ...
              <div className="mt-10 space-y-5">
                <div className="flex items-center gap-4">
                  ...
                  <span className="lg:text-lg text-[15px] text-[#1E293B]">
      ...
      <section className="lg:py-24 py-12 bg-gradient-to-b from-slate-50 to-white">
        <div className="section-container">
          <div className="max-w-5xl mx-auto">
            <div className="grid md:grid-cols-2 overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-xl">
              {/* Left */}
              <div className="lg:p-10 p-4 relative group">
                ...
                <div className="relative z-10">
                  <h3 className="flex items-center gap-3 lg:text-2xl text-xl font-bold text-slate-900 mb-4">
                  ...
                  <div className="lg:space-y-5 space-y-1">
                    {[
                      ...
                      <div
                        key={index}
                        className="flex items-center gap-4 lg:p-3 p-2 rounded-xl hover:bg-green-50 hover:translate-x-2 transition-all duration-300"
                      >
                        <span className="lg:min-w-[42px] lg:h-10  min-w-[30px] h-6  flex items-center justify-center rounded-lg bg-gradient-to-r from-green-500 to-emerald-400 text-white lg:text-sm text-[14px]">
                          0{index + 1}
                        </span>

                        <span className="lg:text-lg text-[15px] text-slate-700">
                          {item}
                        </span>
                      </div>
                    ))}
              ...
              {/* Right */}
              <div className="lg:p-10 p-4 border-t md:border-t-0 md:border-l border-slate-200 relative group">
                ...
                <div className="relative z-10">
                  ...
                  <div className="lg:space-y-5 space-y-1">
                    {[
                      ...
                      <div
                        key={index}
                        className="flex items-center gap-4 lg:p-3 p-2 rounded-xl hover:bg-red-50 hover:translate-x-2 transition-all duration-300"
                      >
                        <span className="lg:min-w-[42px] lg:h-10  min-w-[30px] h-6 flex items-center justify-center rounded-lg bg-gradient-to-r from-red-500 to-rose-400 text-white font-bold">
                          ✕
                        </span>

                        <span className="lg:text-lg text-[15px] text-slate-500">
                          {item}
                        </span>
                      </div>
                    ))}
